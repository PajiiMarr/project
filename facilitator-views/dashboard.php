<section class="container-fluid h-100 py-4 px-4">
    <!-- Header Section -->
    <div class="h-18 w-100 border-bottom mb-4">
    ...
    <!-- Main Content -->
    <div class="container-fluid shadow rounded bg-white p-4">
        <!-- Filter Section -->
        <div class="row mb-4">
        ...
        <div class="row g-3 mb-5">
            <div class="col-12 col-sm-6 col-md-3">
                <div class="reports shadow rounded p-3 d-flex flex-column align-items-center bg-white">
